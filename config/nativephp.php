...
return [
    ...
    */
    ...
    'android' => [
        ...
        // Set to false only if download fails with SSL/certificate errors (e.g. on Windows without cacert). Prefer fixing php.ini curl.cainfo instead.
        'verify_ssl' => env('NATIVEPHP_ANDROID_VERIFY_SSL', true),

        // Timeout in seconds for "composer install" during Android build (default 900 = 15 min). Increase if install times out.
        'composer_install_timeout' => (int) env('NATIVEPHP_COMPOSER_INSTALL_TIMEOUT', 900),
        // Timeout for "composer dump-autoload --optimize" step (default 300 = 5 min).
        'composer_dump_autoload_timeout' => (int) env('NATIVEPHP_COMPOSER_DUMP_AUTOLOAD_TIMEOUT', 300),
