...
class QuizSetting extends Page
{
    ...
    public function mount()
    {
        $this->form->fill([
            ...
            'enable_question_explanations' => getUserSettings('enable_question_explanations') ?? 0,
        ]);
    }
        ...
        return $form
            ->schema([
                ToggleButtons::make('hide_participant_email_in_leaderboard')
                    ...
                    ->inline()
                    ->required(),
                ToggleButtons::make('enable_question_explanations')
                    ->label(__('messages.setting.enable_question_explanation') . ':')
                    ->options([
                        '1' => __('messages.setting.show'),
                        '0' => __('messages.setting.hide'),
                    ])
