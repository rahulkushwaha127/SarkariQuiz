            ...
            <details class="border border-white/10 bg-white/5 p-4 group">
                ...
                <form method="POST" action="{{ route('clubs.point_master', $club) }}" class="mt-3 flex flex-wrap items-end gap-2" data-club-ajax-form="true">
                    ...
                    <label class="flex-1 min-w-0">
                        ...
                        <select name="user_id" class="student-select w-full rounded-lg border border-white/20 px-3 py-2.5 text-sm focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/30">
