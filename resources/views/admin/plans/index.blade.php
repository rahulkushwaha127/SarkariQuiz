...
<div class="space-y-6">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Creator plans</h1>
            <p class="mt-1 text-sm text-slate-600">Plans for creators: limits on quizzes, batches, AI usage, etc. Assign from Users (creators).</p>
        </div>

        <a href="#"
           data-ajax-modal="true"
           data-title="Create creator plan"
           data-size="md"
